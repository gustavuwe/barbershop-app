import { EyeIcon, FootprintsIcon, HeadingIcon, SearchIcon } from "lucide-react"
...
const Home = async () => {
  ...
  }) // TODO: in future, use a query to get popular barbershops by number of services confirmed
  return (
    <div>
      <Header />
      <div className="p-5">
